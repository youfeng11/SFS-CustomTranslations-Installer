...
import com.youfeng.sfs.ctinstaller.ui.common.component.ErrorCard
import com.youfeng.sfs.ctinstaller.ui.common.component.RadioOptionItem
import com.youfeng.sfs.ctinstaller.ui.component.OverflowMenu
import com.youfeng.sfs.ctinstaller.util.openUrlInBrowser
...
fun UiEventAwareHandler(
    ...
    LaunchedEffect(viewModel) {
        viewModel.uiEvent.collect { event ->
            when (event) {
                is MainUiEvent.RequestSafPermissions -> {
                    safLauncher.launch(event.sfsDataUri)
                }

                is MainUiEvent.PermissionRequestCheck -> {
                    requestPermissionLauncher.launch(Manifest.permission.WRITE_EXTERNAL_STORAGE)
                }

                is MainUiEvent.RedirectToSystemSettings -> {
...
private fun LazyItemScope.UpdateCard(updateMessage: String) {
    ...
    CardWidget(
        ...
        onClick = {
            context.openUrlInBrowser(ApiEndpoints.LATEST_RELEASE_URL)
        },
        text = {
                ...
                Column(
                    ...
                    RadioOptionItem(
                        ...
                        summary = if (uiState.customTranslationsName == null)
                            stringResource(R.string.not_selected_text)
                        else
...
private fun PermissionRequestDialog(
    uiState: MainUiState,
    selectedOption: PermissionRadioOptionModel,
    optionsOnClick: (option: PermissionRadioOptionModel) -> Unit,
